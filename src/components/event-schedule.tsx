  ...
  const events: { preEvent: Event[]; day1: Event[]; day2: Event[] } = {
    ...
    day2: [
      ...
      },
      {
        id: "d2-pitch-arena",
        time: "10:00 - 17:00",
        title: "Pitch Arena: Idea to Reality (Day 2)",
        category: "pitching",
        venue: "314, 315, 316",
        speaker: "3 Industry Mentors",
        description: "Step into the arena! Founders pitch to top-tier mentors for real-time feedback and expert guidance to launch their ideas.",
      ...
      },
      {
        id: "d2-biz-arena",
        time: "10:00 - 13:00",
        title: "Biz Arena League: Build Your Empire (Day 2)",
        category: "competitions",
        venue: "301, TIMSR",
        speaker: "Business Mentors",
        description: "Step into the founder's seat. Run a virtual startup in this fast-paced simulation. Make critical decisions on product, marketing, and funding to outmaneuver competitors and dominate the market.",
      ...
      },
      {
        ...
        venue: "SH-1",
        speaker: null,
        description: "A national-level, Ministry of Education (MIC)-aligned initiative featuring pre-summit innovation engagements and AI-focused activities across HEIs, designed to build problem-solving skills, foster innovation culture, and prepare students for TCET E-Summit 2026.",
        duration: "2 hours",
        eligibility: "All pass holders",
      },
    ],
