...
export function EventsListing({ onNavigate }: EventsListingProps) {
  ...
  const allEvents = [
    // PITCHING EVENTS
    {
      ...
      time: "11:30 AM – 1:30 PM (Day 1), 9:30 AM – 1:30 PM (Day 2), afternoon sessions 2:30–5:00 PM",
    ...
    },
    {
      ...
      date: "February 2-3, 2026",
      time: "11:30 AM – 1:30 PM (Day 1), 2:30 – 5:00 PM (Day 1 afternoon)",
    ...
    },
    {
      ...
      date: "February 2-3, 2026",
      time: "11:30 AM – 1:30 PM (Day 1), 9:30 AM – 1:30 PM (Day 2), 2:30–5:00 PM (Day 1 afternoon)",
      venue: "SSC TIMSR",
    ...
    },
    {
      ...
      date: "February 2-3, 2026",
      time: "11:30 AM – 1:30 PM (Day 1), 9:30 AM – 1:30 PM (Day 2), continues afternoon on Day 1 2:30–5:00 PM",
      venue: "SH-3",
      prize: "₹10,000",
      eligibility: "All pass holders (Pixel, Silicon, Quantum)",
    ...
    // NETWORKING EVENTS
    {
      ...
      time: "11:30 AM – 1:30 PM (Day 1), continues 2:30–5:00 PM",
      venue: "Lobby Area",
