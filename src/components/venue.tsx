...
export function Venue() {
  const venues = [
    ...
    },
    {
      name: "SSC TIMSR",
      capacity: "Large Hall",
      events: ["The Incubator Summit: Earn Your Launchpad (Day 1 & 2)", "The Panel Discussion: Get the Final Insights (Day 2)", "Closing Ceremony & Prize Distribution (Day 2)"],
    ...
    },
    {
      ...
      events: ["The Internship Fair: Build Your Founding Team (Day 1 & 2)", "The Startup Expo: Display Your First Prototype (Day 1)"],
