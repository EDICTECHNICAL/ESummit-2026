...
export function Venue() {
  const venues = [
    ...
    },
    {
      name: "SSC TIMSR",
      capacity: "Large Hall",
      events: ["The Incubator Summit: Earn Your Launchpad (Day 1 & 2)"],
    ...
    },
    {
      ...
      capacity: "Large Hall",
      events: ["The Internship Fair: Build Your Founding Team (Day 1 & 2)"],
    ...
    },
    {
      ...
      events: ["IPL Auction: The Bid for Brilliance (Day 1 & 2)"],
      features: ["Interactive screens", "Team seating", "Bidding setup"],
      floor: "6th Floor TIMSR",
    },
    {
      name: "301 TIMSR",
      capacity: "Classroom",
    ...
    },
    {
      ...
      events: ["Design Thinking & Innovation Strategy Workshop (Day 1 & 2)"],
    ...
    },
    {
      name: "Lab 524 / 525",
      capacity: "Workshop Lab",
      events: ["Finance & Marketing for Startups Workshop (Day 1 & 2)"],
    ...
    {
      name: "Seminar Hall, 2nd floor, TSAP / Internal General Reading Room",
      capacity: "Seminar Hall & Reading Room",
      events: ["Startup Youth Conclave: Connect with Top E-Cells (Day 2)"],
      features: ["Panel seating", "Presentation stage", "E-Cell networking area"],
      floor: "2nd Floor TSAP & Internal",
    },
    {
      name: "Auditorium (D-1)",
      capacity: "1000+ seats",
      events: ["Inauguration Ceremony (Day 1)"],
    ...
    },
    {
      name: "Auditorium (D-2)",
      capacity: "1000+ seats",
      events: ["The Panel Discussion: Get the Final Insights (Day 2)", "Closing Ceremony & Prize Distribution (Day 2)"],
      features: ["Premium sound system", "LED screens", "VIP seating", "Live streaming"],
      floor: "Main Auditorium",
    },
  ];
